...
<div class="email-app mb-4">
    <nav>
        ...
        <a href="compose_email.php" class="btn btn-danger btn-block"><i class="icon-plus"></i> Compose</a>
            ...
            <li class="nav-item">
                <a class="nav-link checked" href="#"><i class="fa fa-star"></i> Stared</a>
            </li>
            <li class="nav-item">
    ...
    <main class="inbox">
        ...
        $day1 = date("Y-m-d");
        $select = "SELECT * FROM starred_mail";
        ...
        ?>
            <li class="message unread">
                <a href="#">
                    <div class="actions">
                    <a href="viewmail.php?id=<?php echo $res['Id'];?>" data-toggle="tooltip" data-placement="bottom" title="view"> <span class="action col"><i class="fa fa-square-o"></i></span></a>
                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="Remove from favourites">  <span class="action col" onClick="remove_('<?php echo $res['Id'];?>')" ><i class="icon-trash"></i></span></a>
                    </div>
                    <div class="header">
                        ...
                        <?php
                         ...
                         $time1= date("g:iA",strtotime($res['Curr_Time']));
                         else
                         $time1= $res['Curr_Day'];
                        ?>
                        <span class="fa fa-paper-clip"><?php echo $time1;?></span>
                        <span class="fa fa-paper-clip"><i class="fa fa-star"></i></span>
                    </div>
                    <div class="title">
