...
<div class="email-app mb-4">
    <nav>
        ...
        <a href="compose_email.php" class="btn btn-danger btn-block"><i class="icon-plus"></i> Compose</a>
            ...
            <li class="nav-item">
                <a class="nav-link checked" href="#"><i class="fa fa-trash-o"></i> Trash</a>
            </li>
            <li class="nav-item">
    ...
    <main class="inbox">
        ...
        <ul class="messages">
        <div>
        <p style='text-align:center;background:rgb(190, 199, 197);padding-bottom: 2px;'>The mail in the trash bin will be visible for 30 days since you deleted it</p>
        </div>
        <?php
        ...
        ?>
            <li class="message unread">
                <a href="#">
                    <div class="actions">
                    <a href="restore.php?id=<?php echo $res['Id'];?>" data-toggle="tooltip" data-placement="bottom" title="restore"> <span class="action col"><i class="fa fa-square-o"></i></span></a>
                    </div>
                    <div class="header">
                        <span class="from"><?php echo $res['Sender'];?></span>
                        <span class="date">
                        <span class="fa fa-paper-clip"><i class="fa fa-trash"></i></span>
                    </div>
                    <div class="title">
            ...
            <?php
              ...
              $td= strtotime($day1);
              $md= strtotime($msg_day);
              $diff= $td - $md;
              $dur = abs(floor($diff /(60 * 60 * 24)));
              if($dur > 30){
                  $id= $res['Id'];
                  $del = "DELETE FROM trash WHERE Id='$id' ";
