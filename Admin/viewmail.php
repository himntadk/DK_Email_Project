...
<div class="email-app mb-4">
    ...
    <main class="inbox">
        ...
        <?php
                ...
                $id= $_GET['id'];
                $select= "SELECT * FROM starred_mail WHERE Id= '$id' ";
                $query= mysqli_query($con,$select);
                $res = mysqli_fetch_array($query);
                $time = date("g:iA",strtotime($res['Curr_Time']));
        ?>
        <div class="message-body">
                ...
                <div>
                 ...
                 <p><a href="makeviewpdf.php?id=<?php echo $res['Id'];?>"><?php echo $res['Pdf'];?></a></p>
                 <p><a href="makeviewimage.php?id=<?php echo $res['Id'];?>"><?php echo $res['Image'];?></a>
                 <?php
                 if(!empty($res['Image'])){
                     ?>
